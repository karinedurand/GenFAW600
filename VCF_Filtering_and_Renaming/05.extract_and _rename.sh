...
VCF_IN="/lustre/durandk/BIG_DATABASE/FULL_BIGDATA/ALLsnp.noindel.vcf.gz"
...
/storage/simple/projects/faw_adaptation/programs/vcftools_0.1.13/bin/vcftools \
   ...
   --recode --stdout > GenFAW600.vcf
    
    
/storage/simple/projects/faw_adaptation/programs/htslib-1.9/bgzip -c GenFAW600.vcf  >>  GenFAW600.vcf.gz
zcat GenFAW600.vcf.gz | sed 's/HiC_scaffold_//'  >> GenFAW600.rename.vcf
